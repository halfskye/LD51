...
namespace Opertoon.Panoply {
	public class PanoplyThumbnailMenu : MonoBehaviour {
		...
		public bool ScreenPointIsInsideMenu(Vector2 point) {
			// camera param not needed here if canvas is set to screen space: overlay
			return RectTransformUtility.RectangleContainsScreenPoint(_menu, point) || RectTransformUtility.RectangleContainsScreenPoint(_menuToggle.GetComponent<RectTransform>(), point);
		}
